...
import algorithm.CCPSO.CCInitialization;
import algorithm.CCPSO.GA;
 ...
 */
public class CCPSO_GA_S_Jsp {
	public static void main(String args[]) {
		int[] S = {2,5,10,50,100,200};
...
//			}
			...
			int lbest = GA.getLBest(population,jsp);
			if(gBest.getFitness() > population.getIndividual(lbest).getFitness()){
				gBest = (Individual)population.getIndividual(lbest).clone(0);
				isUpdate = true;
			}
