...
import algorithm.CCPSO.bestPostionUpdate;
import algorithm.CCPSO.postionUpdate;
...
import algorithm.CCPSO.variation;
import java.util.ArrayList;

/**
 * Created by wwhh on 2014/6/30.
 */
public class CCPSO_1JspTest {
	public static void main(String args[]){
		...
		while(t < parameter.getNumOfEvolvedIndividual()){
			...
			//对于每一个染色体，在原来的 CCPSO 之前先进行一次自我的交叉变异
			variation.PopulationVariation(population,randomIndex);
